...
internal static partial class Program
{
    private static async ValueTask EditingPreservesConfigurationAndLocksMinecraft()
    {
        ...
        try
        {
            ...
            AssertTrue(replaced.IsSuccess, string.Join(" | ", fixture.Store.ReadCollection<PCL.Services.Tasks.TaskCenterEntry>(fixture.Store.Resolve(PCL.Services.Tasks.TaskCenterStateContract.EntriesKey)).Items.Select(item => item.ErrorMessage)));
