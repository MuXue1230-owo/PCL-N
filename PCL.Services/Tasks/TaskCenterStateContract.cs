...
public static class TaskCenterStateContract
{
    ...
    {
        builder.Cell<TaskCenterSummary>(SummaryKey, "PCL.Services.Tasks");
        builder.Collection<TaskCenterEntry, string>(EntriesKey, "PCL.Services.Tasks", entry => entry.TaskId);
    }
}
