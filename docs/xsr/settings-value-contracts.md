...
Apply timing is a contract for future consumers, not a claim that this stage has enabled a setting in the UI. All catalog entries currently remain unavailable until their actual consumer and UI are connected. Profile and Temporary have resolution semantics but reject public mutation.
